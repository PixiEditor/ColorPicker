...
namespace ColorPicker.Models.ColorSpaces
{
	public static class OkHelper
	{
		...
		private static LC FindCusp(double a, double b)
		{
			...
			RGB rgb_at_max = OklabToLinearSrgb(new Lab()
			{
				L = 1, 
				a = S_cusp * a, 
				b = S_cusp * b
		...
		public static Tuple<double, double, double> OkHslToSrgb(double h, double s, double l)
		{
			if (l == 1.0)
			{
				return new Tuple<double, double, double>(1.0, 1.0, 1.0);
			}
			else if (l == 0.0)
			{
			...
			RGB rgb = OklabToLinearSrgb(new Lab()
			{
				L = L, 
				a = C * a_, 
				b= C * b_
		...
		public static Tuple<double, double, double> SrgbToOkHsl(double r, double g, double b)
		{
			Lab lab = LinearSrgbToOklab(new RGB()
			{
				r = SrgbTransferFunctionInverse(r),
				g = SrgbTransferFunctionInverse(g),
				b = SrgbTransferFunctionInverse(b)
			});
		...
		public static Tuple<double, double, double> OkHsvToSrgb(double h, double s, double v)
		{
			double a_ = Math.Cos(2.0 * Math.PI * h);
			double b_ = Math.Sin(2.0 * Math.PI * h);
			...
			RGB rgb_scale = OklabToLinearSrgb(new Lab()
			{
				L = L_vt, a = a_* C_vt, b = b_ *C_vt
			});
		...
		public static Tuple<double, double, double> SrgbToOkHsv(double r, double g, double b)
		{
			Lab lab = LinearSrgbToOklab(new RGB() 
			{
				r = SrgbTransferFunctionInverse(r),
